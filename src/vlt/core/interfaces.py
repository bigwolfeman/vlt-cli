...
class IVaultService(ABC):
    ...
    @abstractmethod
    def create_thread(self, project_id: str, name: str, initial_thought: str, author: str = "user") -> Any: ...
    
    @abstractmethod
    def add_thought(self, thread_id: str, content: str, author: str = "user") -> Any: ...
