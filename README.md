...
- **Project & Thread Management**: Organize your thoughts into hierarchical contexts.
...
- **Semantic Search**: Recall past decisions and reasoning using natural language.
- **Knowledge Graph**: Tag (`#bug`) and Link (`relates to`) thoughts to build a connected web of reasoning.

## Requirements

- Python 3.11+
- An [OpenRouter](https://openrouter.ai/) API Key (for Summarization and Search).
